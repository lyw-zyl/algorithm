...
void AdjMatrix(unsigned int adjMat[][vexCounts])  //邻接矩阵表示法
{
    ...
    adjMat[0][1] = 28; adjMat[0][5] = 10;
    adjMat[1][0] = 28; adjMat[1][2] = 16; adjMat[1][6] = 14;
    adjMat[2][1] = 16; adjMat[2][3] = 12;
    adjMat[3][2] = 12; adjMat[3][4] = 22; adjMat[3][6] = 18;
    adjMat[4][3] = 22; adjMat[4][6] = 24; adjMat[4][5] = 25;
    adjMat[5][0] = 10; adjMat[5][4] = 25;
    adjMat[6][1] = 14; adjMat[6][3] = 18; adjMat[6][4] = 24;
}
